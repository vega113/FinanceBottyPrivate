...
var $strongName = 'C65560D30AE5EA0A9282B13FF25082FE';
...
function $DivLogger(this$static){
  ...
  $setCellHorizontalAlignment_0(resizePanel, ($clinit_273() , ALIGN_RIGHT));
  $setWidget(this$static.scrollPanel, this$static.logTextArea);
  $setVisible_(this$static.logDockPanel, false);
  $add_3(($clinit_290() , get_0(null)), this$static.logDockPanel, 0, 0);
...
function $makeHeader(this$static){
  ...
  masterPanel.horzAlign = ($clinit_273() , ALIGN_RIGHT);
...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_245() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_245() , detachCommand));
}
...
function $DivLogger$LogDockPanel(this$static, this$0){
  ...
  this$static.horzAlign = ($clinit_273() , ALIGN_DEFAULT);
  this$static.vertAlign = ($clinit_277() , ALIGN_TOP);
...
function onMouseMove(event_0){
  ...
  if (this.dragging) {
    ...
    $setWidgetPosition(($clinit_290() , get_0(null)), this.this$0.logDockPanel, absX - this.dragStartX, absY - this.dragStartY);
  }
}
...
function $PortfolioBottyGadgetImpl(this$static){
  ...
  $initRemoteLogger(($clinit_290() , get_0(null)));
  return this$static;
}
...
function $onSuccess(this$static, result){
  ...
  if (selectedPortfolioId != null) {
    size = ($clinit_102() , this$static.this$0.portfoliosList.element).options.length;
    for (i = 0; i < size; ++i) {
...
function $getScrollLeft(doc){
  return ($clinit_102() , $equals_1(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body).scrollLeft || 0;
}
...
function $getRelativeX(this$static, target){
  ...
  return (($clinit_102() , e).clientX || 0) - $getAbsoluteLeft(target) + (target.scrollLeft || 0) + $getScrollLeft(target.ownerDocument);
}

function $getRelativeY(this$static, target){
  var e;
  e = this$static.nativeEvent;
  return (($clinit_102() , e).clientY || 0) - $getAbsoluteTop(target) + (target.scrollTop || 0) + $getScrollTop(target.ownerDocument);
}
...
function ensureHiddenDiv(){
  if (!hiddenDiv) {
    ...
    ($clinit_290() , $doc.body).appendChild(hiddenDiv);
  }
}
...
function $Button(this$static, html){
  var e;
  $ButtonBase(this$static, (e = ($clinit_102() , $doc).createElement('BUTTON') , e.type = 'button' , e));
...
function $DockPanel$LayoutData(this$static, dir){
  this$static.hAlign = ($clinit_273() , ALIGN_DEFAULT).textAlignString;
  this$static.vAlign = ($clinit_277() , ALIGN_TOP).verticalAlignString;
...
function $FocusPanel(this$static){
  var e;
  this$static.element = (e = ($clinit_102() , $doc).createElement('div') , e.tabIndex = 0 , e);
  return this$static;
}
...
function $checkIndex(this$static, index){
  if (index < 0 || index >= ($clinit_102() , this$static.element).options.length) {
    throw $IndexOutOfBoundsException(new IndexOutOfBoundsException);
  }
}
...
function $getValue_0(this$static, index){
  ...
  return ($clinit_102() , this$static.element).options[index].value;
}
