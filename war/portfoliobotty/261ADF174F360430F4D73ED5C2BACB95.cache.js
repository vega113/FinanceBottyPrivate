...
var $strongName = '261ADF174F360430F4D73ED5C2BACB95';
...
function $DivLogger(this$static){
  ...
  $setCellHorizontalAlignment_0(resizePanel, ($clinit_280() , ALIGN_RIGHT));
  $setWidget(this$static.scrollPanel, this$static.logTextArea);
  $setVisible_(this$static.logDockPanel, false);
  $add_3(($clinit_297() , get_0(null)), this$static.logDockPanel, 0, 0);
...
function $makeHeader(this$static){
  ...
  for (i = 0; i < levels.length; ++i) {
    ...
    $addDomHandler(this$static.levelButtons[i], $DivLogger$2(new DivLogger$2, level), ($clinit_122() , $clinit_122() , TYPE_0));
  }
  ...
  $addDomHandler(clearButton, new DivLogger$3, ($clinit_122() , $clinit_122() , TYPE_0));
  ...
  masterPanel.horzAlign = ($clinit_280() , ALIGN_RIGHT);
...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_252() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_252() , detachCommand));
}
...
function $DivLogger$LogDockPanel(this$static, this$0){
  ...
  this$static.horzAlign = ($clinit_280() , ALIGN_DEFAULT);
  this$static.vertAlign = ($clinit_284() , ALIGN_TOP);
...
function $DivLogger$MouseDragHandler(this$static, dragHandle, this$0){
  ...
  $addDomHandler(dragHandle, this$static, ($clinit_147() , $clinit_147() , TYPE_1));
  $addDomHandler(dragHandle, this$static, ($clinit_151() , $clinit_151() , TYPE_3));
  $addDomHandler(dragHandle, this$static, ($clinit_149() , $clinit_149() , TYPE_2));
  return this$static;
}
...
function onMouseMove(event_0){
  ...
  if (this.dragging) {
    ...
    $setWidgetPosition(($clinit_297() , get_0(null)), this.this$0.logDockPanel, absX - this.dragStartX, absY - this.dragStartY);
  }
}
...
function $DivLogger$MouseResizeHandler(this$static, resizePanel, this$0){
  ...
  hamh = resizePanel;
  $addDomHandler(hamh, this$static, ($clinit_149() , $clinit_149() , TYPE_2));
  $addDomHandler(hamh, this$static, ($clinit_147() , $clinit_147() , TYPE_1));
  $addDomHandler(hamh, this$static, ($clinit_151() , $clinit_151() , TYPE_3));
  return this$static;
}
...
function formatDate(date, formatMask){
  $clinit_27();
  return $format_0($DateTimeFormat(new DateTimeFormat, formatMask, $getDateTimeConstants(($clinit_184() , $clinit_184() , instance_0))), date);
}
...
function $PortfolioBottyGadgetImpl(this$static){
  ...
  $initRemoteLogger(($clinit_297() , get_0(null)));
  return this$static;
}
...
function $ensureInjected(this$static){
  if (!this$static.injected) {
    ...
    $clinit_114();
    $push_0(toInject, ($clinit_184() , '@CHARSET "UTF-8";.Gxh4pkcDB{color:#b8b8b8;font-style:italic;}.Gxh4pkcP{font-style:italic;}.Gxh4pkcEB{background-color:#f8f8f8;border:solid;border-color:99CCFF;}.Gxh4pkcO{background:#c9e2fc;font-family:fantasy;font-size:13;color:DarkSkyBlue;}.Gxh4pkcFB{background:#a3d1ff;}.Gxh4pkcN{background:#c9e2fc;vertical-align:top;}.Gxh4pkcL{background:#6cf;}.Gxh4pkcM{border-bottom:solid 0 #aaa;margin-bottom:0;}.Gxh4pkcHB{color:#d80000;}.Gxh4pkcAB{color:black;}.Gxh4pkcBB{color:#060;}.Gxh4pkcCB{background-color:#c9e2fc;height:40px;}'));
    schedule();
    return true;
  }
  return false;
...
function $populatePortfolioData(this$static, flexTable, portfolios){
  ...
  fmt = ($clinit_188() , $NumberFormat_0(new NumberFormat, '###.##', ['USD', 'US$', 2, 'US$'], true));
...
function $getAbsoluteLeft(elem){
  ...
  return $getBoundingClientRectLeft(elem) + $getScrollLeft(($clinit_101() , doc));
}

function $getAbsoluteTop(elem){
  var doc;
  doc = elem.ownerDocument;
  return $getBoundingClientRectTop(elem) + $getScrollTop(($clinit_101() , doc));
}
...
function $execute(){
  ($clinit_114() , needsInjection) && flush(null);
}
...
function $clinit_120(){
  ...
  TYPE = $DomEvent$Type(new DomEvent$Type, 'change', ($clinit_120() , new ChangeEvent));
}
...
function $clinit_122(){
  ...
  TYPE_0 = $DomEvent$Type(new DomEvent$Type, 'click', ($clinit_122() , new ClickEvent));
}
...
function $getRelativeX(this$static, target){
  ...
  return (($clinit_101() , e).clientX || 0) - (doc = target.ownerDocument , $getBoundingClientRectLeft(target) + $getScrollLeft_1($equals_1(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body)) + $getScrollLeft_1(target) + $getScrollLeft(target.ownerDocument);
}

function $getRelativeY(this$static, target){
  var e, doc;
  e = this$static.nativeEvent;
  return (($clinit_101() , e).clientY || 0) - (doc = target.ownerDocument , $getBoundingClientRectTop(target) + (($equals_1(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body).scrollTop || 0)) + (target.scrollTop || 0) + $getScrollTop(target.ownerDocument);
}
...
function $clinit_147(){
  ...
  TYPE_1 = $DomEvent$Type(new DomEvent$Type, 'mousedown', ($clinit_147() , new MouseDownEvent));
}
...
function $clinit_149(){
  ...
  TYPE_2 = $DomEvent$Type(new DomEvent$Type, 'mousemove', ($clinit_149() , new MouseMoveEvent));
}
...
function $clinit_151(){
  ...
  TYPE_3 = $DomEvent$Type(new DomEvent$Type, 'mouseup', ($clinit_151() , new MouseUpEvent));
}
...
function $clinit_184(){
  ...
  instance_0 = ($clinit_184() , new LocaleInfo);
}
...
function $clinit_188(){
  ...
  $ensureNumberConstants(($clinit_184() , $clinit_184() , instance_0));
}
...
function $get_2(this$static, index){
  ...
  var func = ($clinit_205() , typeMap)[typeof v];
...
function toString_8(){
  return $clinit_321() , '' + this.value_0;
}
...
function $clinit_202(){
  ...
  instance_1 = ($clinit_202() , new JSONNull);
}
...
function div_0(a, b){
  ...
  if (a[0] == 0 && a[1] == 0) {
    return $clinit_215() , ZERO;
  }
  if (eq(a, ($clinit_215() , MIN_VALUE))) {
...
function fromDouble(value){
  ...
  if (value < -9223372036854775808) {
    return $clinit_215() , MIN_VALUE;
  }
  if (value >= 9223372036854775807) {
    return $clinit_215() , MAX_VALUE;
  }
  if (value > 0) {
...
function fromInt(value){
  ...
  if (value > -129 && value < 128) {
    rebase = value + 128;
    result = ($clinit_214() , boxedValues)[rebase];
...
function shru(a, n){
  ...
  n &= 63;
  sr = shr(a, n);
  a[1] < 0 && (sr = add_0(sr, shl(($clinit_215() , TWO), 63 - n)));
  return sr;
}
...
function toDoubleRoundDown(a){
  ...
  magnitute = round_int(Math.log(a[1]) / ($clinit_215() , LN_2));
  if (magnitute <= 48) {
    return a[1] + a[0];
  }
   else {
...
function ensureHiddenDiv(){
  if (!hiddenDiv) {
    ...
    ($clinit_297() , $doc.body).appendChild(hiddenDiv);
  }
}
...
function onClosing(){
  var event_0;
  if (closeHandlersInitialized) {
    event_0 = ($clinit_236() , new Window$ClosingEvent);
...
function $DecoratorPanel_0(this$static, rowStyles, containerIndex){
  ...
  for (i = 0; i < rowStyles.length; ++i) {
    row = (trElem = $createElement($doc, 'tr') , trElem['className'] = rowStyles[i] , $clinit_184() , trElem.appendChild(createTD(rowStyles[i] + 'Left')) , trElem.appendChild(createTD(rowStyles[i] + 'Center')) , trElem.appendChild(createTD(rowStyles[i] + 'Right')) , trElem);
...
function $DockPanel$LayoutData(this$static, dir){
  this$static.hAlign = ($clinit_280() , ALIGN_DEFAULT).textAlignString;
  this$static.vAlign = ($clinit_284() , ALIGN_TOP).verticalAlignString;
...
function $clinit_280(){
  ...
  ALIGN_DEFAULT = ($clinit_184() , ALIGN_LEFT);
}
...
function valueOf(i){
  ...
  if (i > -129 && i < 128) {
    rebase = i + 128;
    result = ($clinit_333() , boxedValues_0)[rebase];
